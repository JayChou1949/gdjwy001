...
public interface PaasZhzyMapper01 extends BaseMapper<PaasZhzy> {
     ...
     * @return
     */
    PaasZhzy getPaasYarnResource(@Param("appName") String appName, @Param("area") String area, @Param("police") String police, @Param("day") Integer day);


    PaasZhzy getPaasLibraResource(@Param("appName") String appName,@Param("area") String area,@Param("police") String police,@Param("day") Integer day);

    PaasZhzy getPaasEsResource(@Param("appName") String appName,@Param("area") String area,@Param("police") String police,@Param("day") Integer day);

    PaasZhzy getPaasRedisResource(@Param("appName") String appName,@Param("area") String area,@Param("police") String police,@Param("day") Integer day);
     ...
     * @return
     */
    PaasZhzy maxEsMemary(@Param("appName") String appName,@Param("area") String area,@Param("police") String police,@Param("day") Integer day);
