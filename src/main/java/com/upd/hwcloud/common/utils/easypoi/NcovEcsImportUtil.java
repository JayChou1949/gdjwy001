...
public class NcovEcsImportUtil {
    ...
    public static NcovEcsOverview getOverviewData(){
        try{
            ...
            List<NcovEcsOverview> list = ExcelImportUtil.importExcel(new FileInputStream(new File("E:/hwyFiles/"+sourceFileName)),NcovEcsOverview.class,params);
    ...
    public static List<NcovIaasVo> getAllocationData(){
        ...
        try{
            ...
            List<NcovIaasVo> list = ExcelImportUtil.importExcel(new FileInputStream(new File("E:/hwyFiles/"+sourceFileName)),NcovIaasVo.class,params);
