...
import com.upd.hwcloud.bean.entity.application.PassGaussdbAccountInfo;
...
import com.upd.hwcloud.dao.application.PassGaussdbInfoMapper;
import com.upd.hwcloud.service.application.IPassGaussdbAccountInfoService;
import com.upd.hwcloud.service.application.IPassGaussdbInfoService;
 ...
 */
@Service
public class PassGaussdbInfoServiceImpl extends ServiceImpl<PassGaussdbInfoMapper, PassGaussdbInfo> implements IPassGaussdbInfoService {
    @Autowired
    private IPassGaussdbAccountInfoService dbInfoService;


    @Override
    public void saveShoppingCart(ShoppingCart<PassGaussdbInfo> shoppingCart) {
        List<PassGaussdbInfo> serverList = shoppingCart.getServerList();
    ...
    @Override
    public void save(ApplicationInfo<PassGaussdbInfo, Object> info) {
        List<PassGaussdbInfo> serverlist = info.getServerList();
    ...
    @Transactional(rollbackFor = Throwable.class)
    @Override
    public void update(ApplicationInfo<PassGaussdbInfo, Object> info) {
    ...
    @Transactional(rollbackFor = Throwable.class)
    @Override
    public void updateShoppingCart(ShoppingCart<PassGaussdbInfo> shoppingCart) {
