...
import com.upd.hwcloud.dao.application.IaasYzmyzyMapper;
 ...
 */
@Service
public class IaasYzmyzyServiceImpl extends ServiceImpl<IaasYzmyzyMapper, IaasYzmyzy> implements IIaasYzmyzyService {
    ...
    @Override
    public void saveShoppingCart(ShoppingCart<IaasYzmyzy> shoppingCart) {

    }

    @Transactional(rollbackFor = Throwable.class)
    @Override
    public void save(ApplicationInfo<IaasYzmyzy, Object> info) {
        List<IaasYzmyzy> serverList = info.getServerList();
    ...
    @Transactional(rollbackFor = Throwable.class)
    @Override
    public void update(ApplicationInfo<IaasYzmyzy, Object> info) {
    ...
    @Transactional(rollbackFor = Throwable.class)
    @Override
    public void updateShoppingCart(ShoppingCart<IaasYzmyzy> shoppingCart) {
...
//    }
    ...
    @Override
    public IPage<CloudDesktopVO> getResourcePage(Long pageNum, Long pageSize, User user,QueryVO queryVO) {
