...
import com.upd.hwcloud.bean.entity.application.PaasApiwg;
import com.upd.hwcloud.bean.entity.application.ShoppingCart;
import com.upd.hwcloud.dao.application.PaasApiwgMapper;
import com.upd.hwcloud.service.application.IPaasApiwgService;
...
//        this.update(new PaasApiwg(),new UpdateWrapper<PaasApiwg>().lambda().eq(PaasApiwg::getAppInfoId,appInfoId)
//                .set(PaasApiwg::getShoppingCartId,shoppingCartId));
//
//
//        this.update(new PaasApiwg(),new UpdateWrapper<PaasApiwg>().lambda().eq(PaasApiwg::getShoppingCartId,shoppingCartId)
//                .set(PaasApiwg::getAppInfoId,""));
//    }
