...
import com.upd.hwcloud.dao.application.PaasSecurityScanMapper;
import com.upd.hwcloud.service.application.IPaasSecurityScanService;
 ...
 */
@Service
public class PaasSecurityScanServiceImpl extends ServiceImpl<PaasSecurityScanMapper, PaasSecurityScan> implements IPaasSecurityScanService {
...
//        this.update(new PaasSecurityScan(),new UpdateWrapper<PaasSecurityScan>().lambda().eq(PaasSecurityScan::getAppInfoId,appInfoId)
//                .set(PaasSecurityScan::getShoppingCartId,shoppingCartId));
//
//
//        this.update(new PaasSecurityScan(),new UpdateWrapper<PaasSecurityScan>().lambda().eq(PaasSecurityScan::getShoppingCartId,shoppingCartId)
//                .set(PaasSecurityScan::getAppInfoId,""));
//    }
}
