...
public interface IPaasZhzyService01 extends IService<PaasZhzy> {
    ...
    PaasZhzy getPaasYarnResource(String appName, String area, String police, Integer day);


    PaasZhzy getPaasLibraResource( String appName, String area, String police, Integer day);

    PaasZhzy getPaasEsResource( String appName, String area, String police, Integer day);

    PaasZhzy getPaasRedisResource(String appName, String area, String police, Integer day);
     ...
     * @return
     */
    PaasZhzy maxEsMemary(String appName, String area, String police, Integer day);
