...
public class SaasApplication extends Model<SaasApplication> {
     ...
     */
    @TableField(exist = false)
    private List<SaasApplicationExt> serviceList;
    ...
    public List<SaasApplicationExt> getServiceList() {
        return serviceList;
    }

    public void setServiceList(List<SaasApplicationExt> serviceList) {
