...
public class ServicePublish extends Model<ServicePublish> {
     ...
     */
    @TableField(exist = false)
    private List<Files> interfaceFileList;

    /**
     * 开发工具包附件
     */
    @TableField(exist = false)
    private List<Files> developmentFileList;
    ...
    public List<Files> getInterfaceFileList() {
        return interfaceFileList;
    }

    public void setInterfaceFileList(List<Files> interfaceFileList) {
        this.interfaceFileList = interfaceFileList;
    }

    public List<Files> getDevelopmentFileList() {
        return developmentFileList;
    }

    public void setDevelopmentFileList(List<Files> developmentFileList) {
    ...
    public String toString() {
        return "ServicePublish{" +
                ...
                ", developmentFileList=" + developmentFileList +
