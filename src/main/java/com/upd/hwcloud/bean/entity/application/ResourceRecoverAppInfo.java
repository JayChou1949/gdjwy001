...
public class ResourceRecoverAppInfo extends Model<ResourceRecoverAppInfo> {
    ...
    public String toString() {
        return "ResourceRecoverAppInfo{" +
        "id=" + id +
        ", creator=" + creator +
        ", creatorIdCard=" + creatorIdCard +
        ", creatorPhone=" + creatorPhone +
        ", recoveredPerson=" + recoveredPerson +
        ", recoveredPersonPhone=" + recoveredPersonPhone +
