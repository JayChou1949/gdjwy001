...
public class ServicePublishApi extends Model<ServicePublishApi> {
    ...
    private List<ApiAcIp> ipList;

    /**
     * api操作
     */
    @TableField(exist = false)
    private List<ApiOperation> apiOperationList;
    ...
    public List<ApiAcIp> getIpList() {
        return ipList;
    }

    public void setIpList(List<ApiAcIp> ipList) {
        this.ipList = ipList;
    }

    public List<ApiOperation> getApiOperationList() {
        return apiOperationList;
    }

    public void setApiOperationList(List<ApiOperation> apiOperationList) {
