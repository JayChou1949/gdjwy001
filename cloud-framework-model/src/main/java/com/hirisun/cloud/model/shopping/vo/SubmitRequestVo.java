...
public class SubmitRequestVo {
    ...
    private static  final Logger logger = LoggerFactory.getLogger(SubmitRequestVo.class);
    ...
    public ApplicationInfoVo convertToApplicationInfo(){
        SubmitRequestConvert submitRequestConvert = new SubmitRequestConvert();
        ApplicationInfoVo info = submitRequestConvert.convert(this);
        return info;
    }

    private static class SubmitRequestConvert extends Converter<SubmitRequestVo,ApplicationInfoVo>{
        @Override
        protected ApplicationInfoVo doForward(SubmitRequestVo submitRequest) {
            logger.info("SubmitRequest: {}",submitRequest);
           ApplicationInfoVo info = new ApplicationInfoVo();
            try {
        ...
        @Override
        protected SubmitRequestVo doBackward(ApplicationInfoVo info) {
        	return null;
        }
    }
}
