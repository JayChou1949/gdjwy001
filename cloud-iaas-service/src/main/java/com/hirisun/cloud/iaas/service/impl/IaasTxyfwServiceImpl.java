...
import com.hirisun.cloud.iaas.mapper.IaasTxyfwMapper;
...
public class IaasTxyfwServiceImpl extends ServiceImpl<IaasTxyfwMapper, IaasTxyfw> implements IIaasTxyfwService {
    ...
    public void saveShoppingCart(ShoppingCartVo shoppingCart) {
    	...
    	List<IaasTxyfw> serverList = JSON.parseObject(JSON.toJSON(shoppingCart.getServerList()).toString(), 
    			new TypeReference<List<IaasTxyfw>>(){});
    ...
    public void save(ApplicationInfoVo info) {
    	...
    	List<IaasTxyfw> serverList = JSON.parseObject(JSON.toJSON(info.getServerList()).toString(), 
    			new TypeReference<List<IaasTxyfw>>(){});
