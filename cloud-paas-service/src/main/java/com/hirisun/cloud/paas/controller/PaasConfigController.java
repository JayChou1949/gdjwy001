...
public class PaasConfigController {
    ...
    @ResponseBody
    public QueryResponseResult create(@LoginUser UserVO user, @RequestBody PaasConfig paas) {
    ...
    @ResponseBody
    public ResponseResult edit(@LoginUser UserVO user, @RequestBody PaasConfig paas) {
