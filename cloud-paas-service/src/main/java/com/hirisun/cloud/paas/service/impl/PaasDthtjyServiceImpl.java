...
import com.hirisun.cloud.paas.mapper.PaasDthtjyMapper;
...
public class PaasDthtjyServiceImpl extends ServiceImpl<PaasDthtjyMapper, 
    ...
    public void saveShoppingCart(ShoppingCartVo shoppingCart) {
    	...
    	List<PaasDthtjy> serverList = JSON.parseObject(JSON.toJSON(shoppingCart.getServerList()).toString(), 
    			new TypeReference<List<PaasDthtjy>>(){});
    ...
    public void save(ApplicationInfoVo info) {
    	...
    	List<PaasDthtjy> serverList = JSON.parseObject(JSON.toJSON(info.getServerList()).toString(), 
    			new TypeReference<List<PaasDthtjy>>(){});
