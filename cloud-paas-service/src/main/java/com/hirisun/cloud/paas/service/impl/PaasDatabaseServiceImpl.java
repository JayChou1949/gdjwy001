...
import com.hirisun.cloud.paas.mapper.PaasDatabaseMapper;
...
public class PaasDatabaseServiceImpl extends ServiceImpl<PaasDatabaseMapper, 
    ...
    public void saveShoppingCart(ShoppingCartVo shoppingCart) {
    	...
    	List<PaasDatabase> serverList = JSON.parseObject(JSON.toJSON(shoppingCart.getServerList()).toString(), 
    			new TypeReference<List<PaasDatabase>>(){});
    ...
    public void save(ApplicationInfoVo info) {
    	...
    	List<PaasDatabase> serverList = JSON.parseObject(JSON.toJSON(info.getServerList()).toString(), 
    			new TypeReference<List<PaasDatabase>>(){});
