...
public class NcovDaasServiceImpl implements NcovDaasService {
    ...
    public HomePageDataVo getHomePageBigData() throws Exception {
        ...
        String res = redisService.get(NcovKey.HOME_PAGE);
        ...
        homePage = homePage();
        redisService.setForTerminable(NcovKey.HOME_PAGE, JSON.toJSONString(homePage), 30, TimeUnit.MINUTES);
        return homePage;
    }
    ...
    private DataGovernanceVo getDataGovernance(String dataType) {
        ...
        String dataGovernanceStr = redisService.get(NcovKey.HOME_PAGE_DAAS_DATA_GOVERNANCE);
        if (StringUtils.isNotBlank(dataGovernanceStr) && !"null".equals(dataGovernanceStr)) {
            ...
            if (StringUtils.isNotBlank(json)) {
                ...
                redisService.setForPerpetual(NcovKey.HOME_PAGE_DAAS_DATA_GOVERNANCE, json);
            }
        }
    ...
    private DataAccessVo getDataAccess(String dataType) {
        ...
        String dataAccessStr = redisService.get(NcovKey.HOME_PAGE_DAAS_DATA_ACCESS);
        if (StringUtils.isNotBlank(dataAccessStr) && !"null".equals(dataAccessStr)) {
            ...
            if (StringUtils.isNotBlank(json)) {
                ...
                redisService.setForPerpetual(NcovKey.HOME_PAGE_DAAS_DATA_ACCESS, json);
    ...
    private Map<String, Map<String, Long>> getDataServiceCount(String dataType) {
        ...
        String dataServiceCountStr = redisService.get(NcovKey.HOME_PAGE_DAAS_DATA_SERVICE_COUNT);
        ...
        if (StringUtils.isNotBlank(dataServiceCountStr) && !"null".equals(dataServiceCountStr)) {
            ...
            if (StringUtils.isNotBlank(json)) {
                ...
                redisService.setForPerpetual(NcovKey.HOME_PAGE_DAAS_DATA_SERVICE_COUNT, json.toString());
            }
        }
    ...
    private DataModelingVo dataModeling(String dataType) {
        ...
        String dataModelingStr = redisService.get(NcovKey.HOME_PAGE_DAAS_DATA_MODELING);
        if (StringUtils.isNotBlank(dataModelingStr) && !"null".equals(dataModelingStr)) {
            ...
            if (StringUtils.isNotBlank(json)) {
                ...
                redisService.setForPerpetual(NcovKey.HOME_PAGE_DAAS_DATA_MODELING, json);
            }
    ...
    private DataSharingVo getDataSharding(String dataType) {
        ...
        String dataSharingStr = redisService.get(NcovKey.HOME_PAGE_DAAS_DATA_SHARING);
        if (StringUtils.isNotBlank(dataSharingStr) && !"null".equals(dataSharingStr)) {
            ...
            if (StringUtils.isNotBlank(json)) {
                ...
                redisService.setForPerpetual(NcovKey.HOME_PAGE_DAAS_DATA_SHARING, json);
            }
        }
