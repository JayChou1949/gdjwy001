...
public class ApplicationInfo<S, I> extends Model<ApplicationInfo<S,I>> {
    ...
    public List<FilesVo> getTempList() {
        return tempList;
    }

    public void setTempList(List<FilesVo> tempList) {
    ...
    public FlowDetailVo getFlowDetail() {
        return flowDetail;
    }

    public void setFlowDetail(FlowDetailVo flowDetail) {
    ...
    public String getExplanationSaas() {
        return explanationSaas;
    }

    public void setExplanationSaas(String explanationSaas) {
        this.explanationSaas = explanationSaas;
    }
    ...
    public void setAreaReport(String areaReport) {
