...
import com.hirisun.cloud.model.iaas.vo.IaasTxyfwVo;
import com.hirisun.cloud.model.iaas.vo.IaasTxyfwbgVo;
...
import com.hirisun.cloud.order.bean.iaas.IaasTxyfwxgImpl;
...
import com.hirisun.cloud.order.bean.paas.PaasRqzyImpl;
import com.hirisun.cloud.order.bean.paas.PaasTyxx;
import com.hirisun.cloud.order.bean.paas.PaasTyyh;
import com.hirisun.cloud.order.bean.paas.PaasTyyhImpl;
import com.hirisun.cloud.order.service.daas.IDaasApplicationService;
import com.hirisun.cloud.order.service.iaas.IIaasTxyfwImplService;
...
import com.hirisun.cloud.order.service.iaas.IIaasTxyfwxgImplService;
import com.hirisun.cloud.order.service.iaas.IIaasTxyfwxgService;
import com.hirisun.cloud.order.service.paas.IPaasBigdataComponentService;
import com.hirisun.cloud.order.service.paas.IPaasComponentImplService;
import com.hirisun.cloud.order.service.paas.IPaasDatabaseImplService;
import com.hirisun.cloud.order.service.paas.IPaasDatabaseService;
import com.hirisun.cloud.order.service.paas.IPaasDistributedDbApplyImplService;
...
import com.hirisun.cloud.order.service.paas.IPaasFirewallOpenService;
import com.hirisun.cloud.order.service.paas.IPaasRqzyImplService;
import com.hirisun.cloud.order.service.paas.IPaasRqzyService;
import com.hirisun.cloud.order.service.paas.IPaasTyxxService;
import com.hirisun.cloud.order.service.paas.IPaasTyyhImplService;
import com.hirisun.cloud.order.service.paas.IPaasTyyhService;
import com.hirisun.cloud.order.service.paas.impl.PaasDistributedDbApplyImpl;
...
public enum FormNum {
    ...
    IAAS_TXYFW(ResourceType.IAAS, "弹性云服务", IaasTxyfwVo.class, IIaasTxyfwService.class, IaasTxyfwImpl.class, IIaasTxyfwImplService.class),

    IAAS_TXYFWXG(ResourceType.IAAS, "弹性云服务修改", IaasTxyfwbgVo.class, IIaasTxyfwxgService.class, IaasTxyfwxgImpl.class, IIaasTxyfwxgImplService.class),

    IAAS_TXYFWBG(ResourceType.IAAS, "弹性云服务变更", IaasTxyfwbgVo.class, IIaasTxyfwbgService.class, IaasTxyfwbgImpl.class, IIaasTxyfwbgImplService.class),
