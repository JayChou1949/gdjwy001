...
import com.hirisun.cloud.model.saas.vo.SaasApplicationExtVo;
...
public class SaasApplication extends Model<SaasApplication> {
     ...
     */
    @TableField(exist = false)
    private List<SaasApplicationExtVo> serviceList;
    ...
    public List<SaasApplicationExtVo> getServiceList() {
        return serviceList;
    }

    public void setServiceList(List<SaasApplicationExtVo> serviceList) {
