...
@Api("daas 购物车保存购物项")
@RequestMapping("/daas/shopping")
@RestController
public class DaasShoppingCartController {

	@Autowired
    private ShoppingCartService shoppingCartService;

    private static final Logger logger = LoggerFactory.getLogger(DaasShoppingCartController.class);
